...
const questions = [
  ...
  {
    question:
      "On a scale of 1 to 5 with 5 as the highest and 1 as the lowest, how do you rate the Duration?",
    options: [1, 2, 3, 4, 5],
  },
  {
    question:
      "On a scale of 1 to 5 with 5 as the highest and 1 as the lowest, how do you rate the Time of the Event?",
    options: [1, 2, 3, 4, 5],
  },
];
  ...
  return (
    <div className="questionary">
      <Form
        id="loginComp"
        style={{ width: "100%" }}
        className="questionary-carousel"
      >
        {" "}
        ...
        <Carousel
          ...
          nextIcon={
            <BsFillArrowRightCircleFill color="#FFC000" size={"50px"} />
          }
          variant={"dark"}
        >
          <Carousel.Item>
