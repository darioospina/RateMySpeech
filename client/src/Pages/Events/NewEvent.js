...
export const NewEvent = () => {
  ...
  return (
    <div style={{ margin: "auto", textAlign: "center" }} className="newevent-section">
      <Form id="loginComp">
        <Form.Group className="mb-3" controlId="formBasicName">
          <Form.Label>Event Name</Form.Label>
          <Form.Control
            type="text"
            placeholder="E.g. Dummy Event"
        ...
        <InputGroup>
          <Form.Control
            as="textarea"
            placeholder="E.g. This is a dummy event description."
